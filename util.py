...
def parse_args():
    ...
    parser.add_argument("--load_in_4bit", action='store_true', help="Load local HF causal LM in 4-bit; useful for 24G GPUs.")
    parser.add_argument("--trust_remote_code", action='store_true', help="Pass trust_remote_code=True to HF model/tokenizer.")
    parser.add_argument("--torch_dtype", default="float16", type=str, choices=["float16", "bfloat16", "float32"], help="dtype for local HF model.")
