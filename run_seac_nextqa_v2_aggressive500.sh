...
N=${N:-500}
OUTDIR=${OUTDIR:-output/seac_nextqa_v2_aggressive500}
mkdir -p "$OUTDIR"
python article2_seac_vqa.py \
  ...
  --start_from_scratch
python eval_seac_compare.py --pred_path "$OUTDIR/seac_nextqa.json" --out_dir "$OUTDIR"
cat "$OUTDIR/seac_nextqa_seac_compare_summary.json"
